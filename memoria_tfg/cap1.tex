...
escribir tu compilador tú capturas el lenguaje que quieres compilar (el lenguaje fuente) en un 
...
Entonces representas el lenguaje objetivo como otro tipo más. Finalmente, el compilador es 
...
escuetos que se comportan muy bien.\\
